...
#+begin_src emacs-lisp
  (use-package emacs
    ...
    (ielm-history-file-name (expand-file-name "cache/ielm-history.eld" user-emacs-directory))
    ...
    (set-face-attribute 'default nil
			...
			:height 120)
    (set-fontset-font t '(#xe0b0 . #xe0bf) (font-spec :family "Symbols Nerd Font Mono"))
    ...
    (setq auto-save-list-file-prefix (expand-file-name "cache/auto-saves/sessions/" user-emacs-directory)
	  auto-save-file-name-transformation `((".*" ,(expand-file-name "cache/auto-saves/" user-emacs-directory) t)))
...
#+begin_src emacs-lisp
  (use-package dockerfile-ts-mode
    ...
    :config
    (add-to-list 'treesit-language-source-alist '(docker "https://github.com/camdencheek/tree-sitter-dockerfile" "main" "src")))
#+end_src
* CUSTOM PACKAGES
#+begin_src emacs-lisp
