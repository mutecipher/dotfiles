...
#+begin_src emacs-lisp
  (use-package emacs
    ...
    (ielm-history-file-name (expand-file-name "ielm-history.eld" cache-directory))
    (kill-do-not-save-duplicates t)
    (create-lockfiles nil)
    (make-backup-files nil)
    (pixel-scroll-precision-mode t)
    (pixel-scroll-precision-use-momentum nil)
    (project-list-file (expand-file-name "projects" cache-directory))
    ...
    (save-place-file (expand-file-name "saveplace" cache-directory))
    ...
    (url-configuration-directory (expand-file-name "url" cache-directory))
    (use-dialog-box nil)
    (use-file-dialog nil)
    ...
    ;; Auto save configs
    (make-directory (expand-file-name "auto-saves" cache-directory) t)
    (setq auto-save-list-file-prefix (expand-file-name "auto-saves/sessions" cache-directory)
  	auto-save-file-name-transformation `((".*" ,(expand-file-name "auto-saves" cache-directory) t)))
...
#+begin_src emacs-lisp
  (use-package dired
    ...
    (image-dired-dir (expand-file-name "cache/images" user-emacs-directory))
    :init
...
#+begin_src emacs-lisp
  (use-package elgot
    :ensure nil
    :custom
    (elgot-autoshutdown t)
    (elgot-events-buffer-config '(:size 0 :format full))
    (elgot-prefer-plaintext nil)
...
#+begin_src emacs-lisp
  (use-package dockerfile-ts-mode
    ...
    :config
    (add-to-list 'treesit-language-source-alist '(docker "https://github.com/camdencheek/tree-sitter-dockerfile")))
#+end_src
* CUSTOM PACKAGES
#+begin_src emacs-lisp
